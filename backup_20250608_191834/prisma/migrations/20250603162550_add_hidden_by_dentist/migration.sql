...
CREATE TABLE "new_Case" (
    ...
    "notes" TEXT,
    "hiddenByDentist" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Case" ("createdAt", "dentistId", "id", "notes", "patientDOB", "patientEmail", "patientFirstName", "patientId", "patientLastName", "patientSex", "reviewerId", "scanFileUrl", "status", "treatmentPlanUrl", "updatedAt") SELECT "createdAt", "dentistId", "id", "notes", "patientDOB", "patientEmail", "patientFirstName", "patientId", "patientLastName", "patientSex", "reviewerId", "scanFileUrl", "status", "treatmentPlanUrl", "updatedAt" FROM "Case";
DROP TABLE "Case";
