// src/app/dashboard/dentist/DentistDashboard.tsx - Fixed upload handling
"use client";
...
import { UploadAdditionalFilesModal } from '@/components/cases/UploadAdditionalFilesModal';
import { AppointmentModal } from '@/components/appointments/AppointmentModal';
import { AccountSettingsModal } from '@/components/modals/AccountSettingsModal';
import { EnhancedAppointmentsView } from '@/components/appointments/EnhancedAppointmentsView';
import { CaseFormData, CaseFiles } from '@/types/case.types';
import { Appointment, AppointmentStatus } from '@/types/appointment.types';
import { ROLES, CASE_STATUS, APPOINTMENT_STATUS, ACTIVITY_TYPE, TARGET_TYPE, PAYMENT_STATUS, SEX_OPTIONS, isValidRole, isValidSex, isValidCaseStatus, isValidAppointmentStatus, isValidActivityType, isValidTargetType, isValidPaymentStatus } from '@dental/shared';
