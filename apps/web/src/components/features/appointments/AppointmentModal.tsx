...
import { Clinic, Appointment, AppointmentStatus } from '@dental/shared';
import { Case, CaseStatus } from '@dental/shared';
...
import { createDateFromInputs } from '@dental/shared';
import { appointmentService } from '@/lib/appointment-client';
